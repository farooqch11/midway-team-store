/*! Pickr 1.7.1 MIT | https://github.com/Simonwep/pickr */ ! function (t, e) {
    ...
    return function (t) {
        ...
        function _(t, e, o, n) {
            return e /= 100, o /= 100, [...g(255 * (1 - d(1, (t /= 100) * (1 - (n /= 100)) + n)), 255 * (1 - d(1, e * (1 - n) + n)), 255 * (1 - d(1, o * (1 - n) + n)))]
        }
        ...
        function k(t = 0, e = 0, o = 0, n = 1) {
            const i = (t, e) => (o = -1) => e(~o ? t.map(t => Number(t.toFixed(o))) : t),
                r = {
                    ...
                    toHEXA() {
                        const t = function (t, e, o) {
                                return b(t, e, o).map(t => v(t).toString(16).padStart(2, "0"))
                            }(r.h, r.s, r.v),
            ...
            const e = {
                    ...
                    _keyboard(t) {
                        ...
                        if (document.activeElement === o.wrapper) {
                            const {
                                lock: o
                            } = e.options, r = "ArrowUp" === i, s = "ArrowRight" === i, a = "ArrowDown" === i, c = "ArrowLeft" === i;
                            if ("keydown" === n && (r || s || a || c)) {
                                let n = 0,
                                    i = 0;
                                "v" === o ? n = r || s ? 1 : -1 : "h" === o ? n = r || s ? -1 : 1 : (i = r ? -1 : a ? 1 : 0, n = c ? -1 : s ? 1 : 0), e.update(S(e.cache.x + .01 * n), S(e.cache.y + .01 * i)), t.preventDefault()
                    ...
                    _tapmove(t) {
                        ...
                        if (t) {
                            ...
                            c = t ? (e || t).clientX : 0, l = t ? (e || t).clientY : 0, c < a.left ? c = a.left : c > a.left + a.width && (c = a.left + a.width), l < a.top ? l = a.top : l > a.top + a.height && (l = a.top + a.height), c -= a.left, l -= a.top
                        } else n && (c = n.x * a.width, l = n.y * a.height);
                        "h" !== i && (r.style.left = "calc(".concat(c / a.width * 100, "% - ").concat(r.offsetWidth / 2, "px)")), "v" !== i && (r.style.top = "calc(".concat(l / a.height * 100, "% - ").concat(r.offsetHeight / 2, "px)")), e.cache = {
                            x: c / a.width,
                            y: l / a.height
                        };
                        const p = S(c / a.width),
        ...
        let x = (() => {
            class t {
                constructor(e, o, {
                    ...
                    variantFlipOrder: i = t.defaultVariantFlipOrder,
                    container: r = document.documentElement.getBoundingClientRect(),
                    forceApplyOnFailure: s = !1,
                    margin: a = 8,
                    position: c = "bottom-start"
                } = {}) {
                    this.o = {
                        positionFlipOrder: n,
                        variantFlipOrder: i,
                ...
                update(t = this.o, e = !1) {
                    ...
                    for (const t of v) {
                        const o = "t" === t || "b" === t,
                            n = h[t],
                            [r, s] = o ? ["top", "left"] : ["left", "top"],
                            [a, c] = o ? [u.height, u.width] : [u.width, u.height],
                            [l, p] = o ? [_, w] : [w, _],
                            [f, m] = o ? [y, g] : [g, y];
                        if (e || !(n < f || n + a > l))
                            for (const a of b) {
                                const l = d[(o ? "v" : "h") + a];
                                if (e || !(l < m || l + c > p)) return i.style[s] = l - u[s] + "px", i.style[r] = n - u[r] + "px", t + a
                            }
                    }
                    return a ? this.update(void 0, !0) : null
                }
            }
            return t.version = "1.3.0", t.defaultVariantFlipOrder = {
                start: "sme",
                middle: "mse",
                end: "ems"
        ...
        class j {
            constructor(t) {
                L(this, "_initializingActive", !0), L(this, "_recalc", !0), L(this, "_nanopop", null), L(this, "_root", null), L(this, "_color", k()), L(this, "_lastColor", k()), L(this, "_swatchColors", []), L(this, "_eventListener", {
                    init: [],
                    save: [],
                    hide: [],
                    show: [],
            ...
            _t(t) {
                return this.options.i18n[t] || j.I18N_DEFAULTS[t]
            }
            _emit(t, ...e) {
            ...
            addSwatch(t) {
                ...
                if (e) {
                    const {
                        _swatchColors: t,
                        _root: o
                    } = this, n = k(...e), i = a('<button type="button" style="color: '.concat(n.toRGBA().toString(0), '" aria-label="').concat(this._t("btn:swatch"), '"/>'));
            ...
            destroy() {
                this._eventBindings.forEach(t => s(...t)), Object.keys(this._components).forEach(t => this._components[t].destroy())
            }
            destroyAndRemove() {
                this.destroy();
                const {
        ...
        L(j, "utils", n), L(j, "version", h.a), L(j, "I18N_DEFAULTS", {
